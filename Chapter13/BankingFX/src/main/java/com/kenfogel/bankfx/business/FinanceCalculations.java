package com.kenfogel.bankfx.business;
...
public class FinanceCalculations {
     ...
     * zero occurs
     */
    public void loanCalculation(FinanceFXBean money)
     ...
     * zero occurs
     */
    public void futureValueCalculation(FinanceFXBean money)
            throws ArithmeticException {
        // Divide APR by 12
        var monthlyRate = money.getRate().divide(
                new BigDecimal("12"), MathContext.DECIMAL64);
     ...
     * zero occurs
     */
    public void savingsGoalCalculation(FinanceFXBean money)
            throws ArithmeticException {
        // Divide APR by 12
        var monthlyRate = money.getRate().divide(
                new BigDecimal("12"), MathContext.DECIMAL64);
